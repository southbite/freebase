module.exports = {
	...
	log:function(message, level, component){
		...
		try{
			...
			if (_this.settings.log_level.indexOf(level) > -1 || (component && _this.settings.log_component  && _this.settings.log_component.indexOf(component) > -1)){
