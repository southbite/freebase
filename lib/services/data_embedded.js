...
module.exports = {
    initialize:function(config, done){
        ...
        if (_this.freebase.config.embedded_filename){

            _this.db = new Datastore({ filename: _this.freebase.config.embedded_filename });
        ...
        if (message.action == 'GET'){
            ...
            var regularPUT = function(){
                ...
                var upsert = function(){
                    ...
                    _this.db.update({path:message.path}, setParameters, {upsert:true}, function(err, updatedCount) {
                        if (!err){
