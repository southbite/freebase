...
//BEGIN SERVER-SIDE ADAPTER - DO NOT REMOVE THIS COMMENT
			...
			var http_adapter = {
				perform_request:function(params, done){
					...
					params.json = {encapsulated:params.json, basetype:basetype};
			...
			var http_adapter = {
				perform_request:function(params, done){
					...
					$.ajax({
					  type: params.method,
					  url: params.uri,
					  data: {encapsulated:params.json, basetype:basetype},
			...
			var client = {
				...
				checkPath:function(path){
					if (path.match(/^[a-zA-Z0-9//_*]+$/) == null)
						throw 'Bad path, can only contain alphanumeric chracters, forward slashes and underscores and a wildcard *, ie: /this/is/an/example/of/1/with/an/_*';
				},
				getHeaders:function(){
